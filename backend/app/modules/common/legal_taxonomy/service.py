...
_ISSUE_DETECTION_RULES: dict[str, tuple[tuple[str, ...], tuple[str, ...]]] = {
    "interpreter_issue": (
        ("без переводчика", "не предоставили переводчика", "право на переводчика"),
        ("переводч", "перевод "),
    ),
    "language_issue": (
        ("язык судопроизводства", "не владеет языком", "не понимал язык"),
        ("язык",),
    ),
    "notice_issue": (
        ("без уведомления", "не был уведомлен", "без извещения", "не получил повестку"),
        ("извещ", "уведомл", "повестк", "вызов"),
    ),
    "service_address_issue": (
        ("по месту регистрации", "по адресу регистрации", "не проживал по адресу"),
        ("регистрац", "адрес"),
    ),
    "foreign_party_issue": (
        ("иностранный гражданин", "иностранец", "турист", "нерезидент"),
        ("иностран", "нерезидент"),
    ),
    "alimony_issue": (
